...
@MapperScan(basePackages= {"com.gdu.home.mapper"})			 //mybatis 지원, 기본적으로 basePackages는 String 배열을 요구, @Mapper가 존재하는 패키지를 작성한다.
@PropertySource(value={"classpath:application.yaml"})  // application.yaml 파일의 속성을 읽어 오자!
